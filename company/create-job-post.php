...
$conn = mysqli_connect($servername,$username,$password,$db);
 ...
 else
 {
  ...
  if (isset($_POST['submit'])) {
                ...
                $sql = " INSERT INTO `createjobpost` ( `jobtitle`, `description`, `minimumsalary`, `maximumsalary`, `experience`, `qualification`,`user_id`,`email_id`) VALUES ( ' $jobtitle', '$description', ' $minimumsalary', '$maximumsalary', '$experience', '$qualification','$crid','$user_id')";
