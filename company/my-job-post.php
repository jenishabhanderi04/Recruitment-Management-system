...
$sql = "SELECT * from createjobpost where user_id = '$crid'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
   ...
   echo '<tr>
      ...
      <td>'.$experience.'</td>
      <td>'.$qualification.'</td>
       <td><a href="upadatejob.php?cjpid='.$cjpid.'" class="edit">Update</a></td>
       <td><a href="delete.php?cjpid='.$cjpid.'" class="del">Delete</a></td>
</tr>
</tbody>';
