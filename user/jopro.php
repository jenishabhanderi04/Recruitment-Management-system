          ...
          $db = "jobs";
           ...
           if($conn)
           {
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql = " INSERT INTO `joprofile` ( `fname`, `lname`, `emailid`, `address`, `city`, `state`, `contactno`, `qulification`, `stream`, `skills`, `aboutme`, `resume`,`user_id`) VALUES ( '$fname', '$lname', '$emailid', '$address', '$city', '$state', '$contactno', '$qulification','$stream','$skills','$aboutme','$resume','$jsrid')";
              ...
              <div class="row">
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control input-lg" id="email" name="emailid" placeholder="Email" value="">
                  </div>
                  <div class="form-group">
